...
/*   Updated: 2024/04/23 18:05:32 by damendez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void check_if_color(t_data *data, char *line)
{
	...
	if (line[0] == 'C')
	{
		...
		&& (ceiling_b >= 0 && ceiling_b <= 255))
			...
			ft_error(data, "Valid identifier but invalid color for Celing\n", 1);
	}	
	else if (line[0] == 'F')
	{
		...
		&& (floor_b >= 0 && floor_b <= 255))
			...
			ft_error(data, "Valid identifier but invalid color for Floor\n", 1);
	}
	else
