...
#    Updated: 2024/05/21 16:12:07 by damendez         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# Source filenames
FILES = cub3d init free checker parser print list_utils renderer map_utils \
		parser_map raycasting input check_map check_textures_and_colors utils
